...
namespace Packman_Game
{
    public partial class Form1 : Form
    {
        ...
        void LoadBlocks()
        {
            ...
            Characters.Block b4 = new Characters.Block(20, 100, new Point(80, 320));
            Characters.Block b5 = new Characters.Block(100, 20, new Point(80, 420));

            Characters.Block b6 = new Characters.Block(100, 20, new Point(420, 420));
            Characters.Block b7 = new Characters.Block(20, 100, new Point(500, 320));
            blocks[0] = b;
            blocks[1] = b1;
            blocks[2] = b2;
            blocks[3] = b3;
        ...
        void LoadDots()
        {
            ...
            Characters.Dots d48 = new Characters.Dots();
            d48.Location = new Point(250,230);
            Characters.Dots d49 = new Characters.Dots();
            d49.Location = new Point(280, 230);
            Characters.Dots d50 = new Characters.Dots();
            d50.Location = new Point(250, 200);
            Characters.Dots d51 = new Characters.Dots();
            d51.Location = new Point(280, 200);
